...
public class BlobMovement : MonoBehaviour 
{
	...
	public enum PlayerState {Idle, Running, Jumping, Falling, Eating, Damaged};
	//Current state
	...
	{	
		...
		if((((Input.GetAxisRaw("Horizontal") > 0.5f || Input.GetAxisRaw("Horizontal") < -0.5f)) && canInput) || isRunning)
		{
